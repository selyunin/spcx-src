...
double dist_pt_pt( const vector<double> &v1, const vector<double> &v2)
{
...
double dist_pt_vec( const vector<double> &v, const std::vector<vector <double> > &vv, int &idx)
{
...
double dist_pt_vec2( const vector<double> &v, const std::vector<vector <double> > &vv, int &index1, int & index2)
{
...
std::vector< vector<double> > uni_sphere(int N, int dim, int max_iter, double tol)
{
 ...
 /* initialize random generator : */
  ...
  boost::variate_generator<boost::mt19937&, boost::uniform_on_sphere<> >
           give_sphere_pt(rng, rsphere);             // glues randomness with mapping
